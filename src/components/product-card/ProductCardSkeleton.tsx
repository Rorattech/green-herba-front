...
export default function ProductCardSkeleton() {
  return (
    <div className="flex flex-col bg-transparent w-full h-full animate-pulse">
      <div className="relative aspect-square lg:aspect-4/5 w-full bg-gray-100 mb-4 shrink-0" />
      <div className="flex flex-col flex-1 items-center text-center px-2">
        <div className="h-5 bg-gray-100 rounded w-4/5 mx-auto mb-2" />
        <div className="h-5 bg-gray-100 rounded w-3/5 mx-auto mb-2" />
        <div className="flex items-center justify-center gap-1 mb-2">
          ...
          <div className="w-6 h-3 bg-gray-100 rounded ml-1" />
        </div>
