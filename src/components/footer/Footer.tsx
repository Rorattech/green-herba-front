        ...
        <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                ...
                <div className="md:col-start-7 md:col-span-6 grid grid-cols-2 md:grid-cols-3 gap-8">
                    <div>
                        <h4 className="text-green-100 text-body-l font-body font-bold mb-6">Shop</h4>
                        <ul className="space-y-4 text-green-100 text-body-m font-body font-medium">
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Shop all</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Best sellers</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Daily essentials</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Targeted support</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Long-term wellness</li>
                        </ul>
                    </div>

                    <div>
                        <h4 className="text-green-100 text-body-l font-body font-bold mb-6">Info</h4>
                        <ul className="space-y-4 text-green-100 text-body-m font-body font-medium">
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Journal</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">About</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">FAQ</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Contact</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Login</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-green-100 text-body-m font-body font-medium">
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Privacy policy</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Terms of service</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Cookies settings</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Shipping policy</li>
                            <li className="hover:text-green-100 cursor-pointer transition-colors">Start a return</li>
                        </ul>
                    </div>
                </div>
            </div>
